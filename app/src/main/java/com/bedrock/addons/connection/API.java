...
import com.bedrock.addons.connection.response.ResponseCode;
import com.bedrock.addons.connection.response.ResponseCommentAdd;
import com.bedrock.addons.connection.response.ResponseCommentList;
import com.bedrock.addons.connection.response.ResponseDevice;
import com.bedrock.addons.connection.response.ResponseHome;
import com.bedrock.addons.connection.response.ResponseInfo;
import com.bedrock.addons.connection.response.ResponseNews;
import com.bedrock.addons.connection.response.ResponseNewsDetails;
import com.bedrock.addons.connection.response.ResponseTopic;
import com.bedrock.addons.data.Constant;
import com.bedrock.addons.model.CommentBody;
import com.bedrock.addons.model.DeviceInfo;
import com.bedrock.addons.model.SearchBody;
